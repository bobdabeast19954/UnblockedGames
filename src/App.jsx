...
import { Search, Gamepad2, Maximize2, Filter, ChevronLeft, ExternalLink } from 'lucide-react';
        ...
        <AnimatePresence mode="wait">
          {!activeGame ? (
            ...
            >
              ...
              <div className="relative flex-1 bg-black rounded-2xl overflow-hidden border border-border shadow-2xl min-h-[60vh]">
                <iframe
              ...
              <div className="bg-card p-6 rounded-2xl border border-border">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                  <div>
                    <span className="text-accent text-xs font-bold uppercase tracking-widest mb-1 block">
                      {activeGame.category}
                    </span>
                    <h3 className="text-2xl font-bold mb-2">{activeGame.title}</h3>
                    <p className="text-zinc-400 max-w-2xl">{activeGame.description}</p>
                  </div>
                  <div className="flex gap-3">
                    <button className="px-6 py-2.5 bg-accent text-black font-bold rounded-xl hover:bg-accent/90 transition-all flex items-center gap-2">
